...
var init = exports.init = function (config) {
  ...
  app.get('/kickoff_bitbucket/:bitbucketId', middleware.require_auth, routes.kickoff_bitbucket);
  ...
  app.get('/api/bitbucket/repos', middleware.require_auth, api_bitbucket.get_repos);
